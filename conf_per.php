<?php
	...
	$glob['mass_country'] = array(0 => "n/a", 1 => "Испания", 2 => "Италия", 3 => "Китай", 4 => "Португалия", 5 => "Россия", 6 => "Польша", 8 => "Германия", 9 => "Турция", 10 => "Украина", 11 => "Белоруссия", 12 => "Франция", 13 => "Финляндия");
	...
	$glob['mass_zatirka_type'] = array(
		...
		6 => "Инструмент",
		7 => "Чистящие средства",
		8 => "Ровнители для пола",
		9 => "Штукатурки и шпаклевки",
		10 => "Латексные добавки",
		11 => "Специальные материалы",
		12 => "Утепление фасадов"
	);
